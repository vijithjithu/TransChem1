...
class DownstreamRegression(nn.Module):
    def __init__(self, drop_rate=0.1):
        ...
        self.Regressor = nn.Sequential(nn.Linear(32 +17, 32),
                                       nn.LayerNorm(32),
                                       nn.Dropout(0.3),
                                       nn.SiLU(),
...
def main(finetune_config):
    ...
    f = open('Xc_chem_feature_names.json')
...
if __name__ == "__main__":
    ...
    finetune_config = yaml.load(open("config_Xc_TransChem_finetune_params.yaml", "r"), Loader=yaml.FullLoader)
